...
- **Adaptive frame cadence.** Full rate while anything is in frame or alerting; backs off to ½ after 3 s of empty frames and ⅓ after 12 s, stretched 1.5× under 20 % battery — never below ~2 fps, and the first sighting snaps straight back to full rate. A covered lens (pocket, hand) idles at 2 fps until light returns. Applies to both the foreground screen and the background service (`ml/FrameCadence.kt`, unit-tested).
