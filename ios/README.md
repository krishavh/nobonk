...
**0.2.3 (build 5)** was installed and launched on a registered iPhone 16 Plus on September 7, 2026. HRD received0.2.1 earlier; the0.2.3 update is ready but awaits reconnection. This is a development installation, not a public App Store or TestFlight release. The Android closed-test link does not install the iPhone app.
